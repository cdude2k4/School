...
printf("<div id=\"menu\">");
printf("<ul>");
printf("<li><a href=\"http://www.cs.mcgill.ca/~ctrinh2/welcome.html\">Return to homepage</a></li>");
printf("<li><a href=\"http://www.cs.mcgill.ca/~tko4/surveyCreation.html\">Click here to create a survey</a></li>");
printf("<li><a href=\"http://www.cs.mcgill.ca/~vwen/survey.html\">Click here to take a survey</a></li>");
printf("</ul>");
printf("</div>");
printf("</BODY>");
}
...
printf("<BODY>");
printf("<p>");
printf("<a href=\"http://cs.mcgill.ca/~ctrinh2/welcome.html\">Return to homepage</a><br>");
printf("<a href=\"http://cs.mcgill.ca/~vwen/login.html\">Return to login</a><br>");
printf("</p>");
printf("</BODY>");
}
return 0;
